    ...
    <>
      <main>
        <div className="wraper">
          <h1>SUBS</h1>
          <p className="info-text">SUBS: "Seoun Broadcasting System"의 약자</p>
          <p className="info-text">
            서운중학교 방송부(A.K.A. SUBS)는 서운중학교의 동아리이며, 점심시간
            음악방송, 교내방송, 서운축제 등 교내의 방송을 담당합니다.
          </p>
          <p className="info-text">
        ...
        <div className="wraper">
          ...
          <div className="faq-wraper">
            ...
            <p className="faq-text">
              A: 웹사이트에서 점심시간에 재생될 음악 신청곡을 받습니다. 그 후
              방송부원들이 신청곡 중 음악을 선정하여 음악을 재생합니다. 신청곡이
              신청했되었으나, 신청곡이 재생되지 않을 수 있습니다.
            </p>
          </div>
          <div className="faq-wraper">
